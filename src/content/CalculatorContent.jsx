        ...
        <div>
         ...
         {(calc.refiPayoffAmount || 0) > 0 && (
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 4, fontSize: 11, color: T.textTertiary }}>
           <span>Estimated payoff: {fmt((calc.refiPayoffAmount || 0) + (calc.refiSecondPayoffAmt || 0) + (calc.refiThirdPayoffAmt || 0))}{((calc.refiSecondPayoffAmt || 0) > 0 || (calc.refiThirdPayoffAmt || 0) > 0) ? " (incl. junior liens)" : ""}</span>

...
export default function SetupContent(props) {
  ...
  const {
    ...
    showRentVsBuy, setShowRentVsBuy, showProp19, setShowProp19, showRateLadder, setShowRateLadder, showVaResidual, setShowVaResidual, skillLevel, onToggleSkillLevel, Inp, Sel, SearchSelect, Note,

...
export function generateEstimateHtml({
 ...
 salesPrice, downPct, loanType, term, rate, hoa,
  ...
  html += `<div class="footer-nmls">Generated by Mortgage Blueprint — powered by RealStack · ${dateStr}</div>`;
